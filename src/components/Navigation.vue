        ...
        <div class = "container">
            ...
            <div class = "nav-links">
                <ul>
                    ...
                    <router-link class = "link" to = "/BlogCreate">Forum</router-link>
...
header {
    ...
    background: linear-gradient(180deg, rgba(235,170,155,1) 0%, rgba(255,207,134,1) 51%, rgba(241,235,190,1) 100%);
    padding: 0 25px;
